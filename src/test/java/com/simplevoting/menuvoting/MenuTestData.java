...
public class MenuTestData {
    /*    public static Menu MENU1 = new Menu(START_SEQ + 6, LocalDate.of(2017, 11, 1), RESTAURANT2, new HashSet<>(Arrays.asList(MENU_DISH5, MENU_DISH6)));
        public static Menu MENU2 = new Menu(START_SEQ + 7, LocalDate.of(2017, 11, 1), RESTAURANT1, new HashSet<>(Arrays.asList(MENU_DISH1, MENU_DISH2)));
        public static Menu MENU3 = new Menu(START_SEQ + 8, LocalDate.of(2017, 11, 1), RESTAURANT3, new HashSet<>(Arrays.asList(MENU_DISH3, MENU_DISH4)));
        public static Menu MENU4 = new Menu(START_SEQ + 9, LocalDate.of(2017, 11, 2), RESTAURANT1, new HashSet<>(Arrays.asList(MENU_DISH7, MENU_DISH8)));
        public static Menu MENU5 = new Menu(START_SEQ + 10, LocalDate.of(2017, 11, 2), RESTAURANT2, new HashSet<>(Arrays.asList(MENU_DISH11, MENU_DISH12)));
        public static Menu MENU6 = new Menu(START_SEQ + 11, LocalDate.of(2017, 11, 2), RESTAURANT3, new HashSet<>(Arrays.asList(MENU_DISH9, MENU_DISH10)));*/
